...
@Entity
@Table(name = "distritos", schema = "santo_domingo_corralon", catalog = "")
public class DistritosEntity {
    ...
    private DepartamentosEntity departamentosByFkdepartamentosid;
    ...
    public boolean equals(Object o) {
        ...
        DistritosEntity that = (DistritosEntity) o;
    ...
    public DepartamentosEntity getDepartamentosByFkdepartamentosid() {
        return departamentosByFkdepartamentosid;
    }

    public void setDepartamentosByFkdepartamentosid(DepartamentosEntity departamentosByFkdepartamentosid) {
